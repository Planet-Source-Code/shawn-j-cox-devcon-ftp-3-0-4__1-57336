...
Begin VB.Form frmMain 
   Caption         =   "DevCon FTP - Not Connected"
   ClientHeight    =   8055
   ClientLeft      =   60
   ClientTop       =   630
   ClientWidth     =   9780
...
'ReReEdited by Fatty(Shawn J. Cox)
...
'==================================================
'Man this guy really didn't like using the same indenting
'methods on more than 10 lines at a time! Took me an hour
'to go through all the code and indent it properly
'Well I suppose I could have used a code indenter but I
'didn't think of that till I starting writting this...
'AFTER I manually indented all the code... lol - Fatty
Option Explicit
...
Dim Y, z As Long
    ...
    For i = 1 To ListView2.ListItems.Count
       ...
       End If
    Next i
    StatusBar1.Panels(2).Text = "Server: " & X & " Files selected, " & z / 1000 & " kb"
End Sub
...
Private Sub lkjsdflk_Click()
 Dim bolResult As Boolean
 Dim strGay As String
 Dim lngResult As Long
 Dim poo, poo2
 strGay = "HELP"
 'bolresult = ftpcommand(session,True,
 bolResult = FtpCommand(session, True, FTP_TRANSFER_TYPE_ASCII, strGay, poo, lngResult)

 MsgBox modWinINet.GetFTPServerReply()
 MsgBox modWinINet.GetWinInetErrDesc(modWinINet.GetLastError)
 MsgBox bolResult & "//" & lngResult
 modWinINet.InternetCloseHandle (lngResult)
End Sub

Private Sub mnu_CHMOD_Click()
 strCFile = ListView2.SelectedItem.Text
 MsgBox strCFile
 frmCHMOD.Show
...
Dim i As Integer
    If ListView1.SelectedItem Is Nothing Then
        ...
        Exit Sub
    Else
        Msg = MsgBox("Are you sure you want delete these files?" & vbCrLf & "These will not be in recycle!", vbQuestion + vbYesNo, App.Title)
        If Msg = vbYes Then
            For i = 1 To ListView1.ListItems.Count
                If ListView1.ListItems(i).Selected = True Then
...
On Error GoTo Err
    ...
    End If
Err:
    If Err.Number = 75 Then MsgBox "An error ocurred while creating the folder." & vbCrLf & "Make sure folder doesn't exist!", vbExclamation, App.Title
    Exit Sub
End Sub
    ...
    Else
        ...
        For i = 0 To ListView1.ListItems.Count - 1
            If ListView1.ListItems(i).Selected = True Then
                ...
                frmProg.Label4.Caption = "Kb sent:"
            End If
        Next i
        frmProg.lbCelkem = z
...
Private Sub zOpenFile_Click()
    ...
    Else
        MsgBox "Nothing To Open! Please Select A File.", vbExclamation, App.Title
    End If
End Sub
...
Dim i As Integer
    ...
    If Not (TView1.SelectedItem Is Nothing) Then
        ...
        If tvNode.Text = ".." Then
            ...
            Exit Sub
        Else
            Msg = MsgBox("Are you sure to remove this folder: " & Chr(34) & tvNode.Text & Chr(34) & "?", vbQuestion + vbYesNo, App.Title)
            If Msg = vbYes Then
...
Dim sRet As String
    ...
    If txtInfo.Text <> "" Then
        ...
        Else
            MsgBox "No name entered, quiting", vbInformation
        End If
    Else
        MsgBox "Nothing to be saved!", vbExclamation
    End If
End Sub
